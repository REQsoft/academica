 		...
 		<div class="container-fluid">
    		...
    		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    			<ul class="nav navbar-nav">
    				<li><a href='<?php echo base_url()?>administrador/usuarios'>Getionar usuarios<span class="sr-only">(current)</span></a></li>
        		<li><a href='<?php echo base_url()?>administrador/eventos'>Gestion de eventos</a></li>
        	</ul>
          <ul class="nav navbar-nav navbar-right">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="<?php echo base_url()?>administrador/cerrar">Cerrar sesion</a></li>
            </ul>
            </li>
          </ul>
    		</div><!-- /.navbar-collapse -->
